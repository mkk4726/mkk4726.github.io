...
export default function PostsSearchClient({ searchQuery, folderStructure }: PostsSearchClientProps) {
        ...
        <div className="flex-1">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              검색 결과: &ldquo;{searchQuery}&rdquo;
            </h1>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              &ldquo;{searchQuery}&rdquo;에 대한 검색 결과입니다.
            </p>
          </div>
