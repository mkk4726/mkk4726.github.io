...
<figure>
<img src="/post/what-is-statistical-bias/처치별_Feature_DensityPlot.png" alt="평가고민" width="100%" />
<figcaption>그림6. 처치 간의 분포 차이</figcaption>
</figure>

의사는 환자의 조건을 보고 처치를 배정하고, 따라서 처치별로 분포가 다르게 형성된 것을 확인할 수 있습니다.
그림 6에서 Cas_ata (눈의 가로 크기)에 대한 처치 분포를 살펴보면, 분포 간에 차이가 보이는 것을 확인할 수 있습니다.
...
Cas_ata (눈의 가로 크기)가 12.5 이하인 환자의 경우 13.2로 처치받은 데이터가 없습니다.
